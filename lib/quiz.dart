...
home: const MyHomePage(title: 'ForGood Weekly Check-In'),
);
}
}
...
@override
// Widget dropDown(List<String> category) {
...
volunteer opportunity @ dosomething.org, Download and use 'Book Share', Donate using
'Amazon Smile', Play 'Free Rice'";
}
...
Container(
child:
Text('1) Are you busy with work or school this week?',textScaleFactor:
1),
...
Container(
child:
Text('2)How are you feeling this week, do you want to
?',textScaleFactor: 1),
decoration: BoxDecoration(
shape: BoxShape.rectangle,
color: Colors.teal.shade100,
...
Container(
child:
Text('3) Do you prefer the outdoors or indoors?',textScaleFactor: 1),
decoration: BoxDecoration(
shape: BoxShape.rectangle,
color: Colors.teal.shade100,
),
...
Container(
child:
Text('4) Are you free Monday-Friday after 3pm?',textScaleFactor: 1),
decoration: BoxDecoration(
shape: BoxShape.rectangle,
color: Colors.teal.shade100,
),
...
Container(
child:
Text('5) Do you want to work with animals?',textScaleFactor: 1),
decoration: BoxDecoration(
shape: BoxShape.rectangle,
color: Colors.teal.shade100,
),
...
Container(
child:
Text('6) Do you want to work with children?',textScaleFactor: 1),
decoration: BoxDecoration(
shape: BoxShape.rectangle,
color: Colors.teal.shade100,
),
...
Container(
child:
Text('7) Are you free Saturday-Sunday before 11am?',textScaleFactor: 1),
decoration: BoxDecoration(
shape: BoxShape.rectangle,
color: Colors.teal.shade100,
),
...
Container(
child:
Text('8) Are you willing to commute 30 minutes every other
day?',textScaleFactor: 1),
decoration: BoxDecoration(
shape: BoxShape.rectangle,
color: Colors.teal.shade100,
),
...
Container(
child:
Text('9) Which do you prefer?',textScaleFactor: 1),
decoration: BoxDecoration(
shape: BoxShape.rectangle,
color: Colors.teal.shade100,
),
...
Container(
child:
Text('10) Are you free Monday-Friday after 3pm?',textScaleFactor: 1),
decoration: BoxDecoration(
shape: BoxShape.rectangle,
color: Colors.teal.shade100,
),
